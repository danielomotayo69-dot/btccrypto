...
<div class="alert alert-dark text-center mt-3">
  ...
  <p class="text-info mb-1">
    <strong>Sample BTC Wallet:</strong><br>
  ...
  <small class="text-muted">
    This is a sample wallet address for display purposes only.
    Payments are processed externally by Simplex.
    Do not close the page during redirection.
  </small>
</div>
